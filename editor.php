<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            <div class = 'editortext'><textarea name="editor1" id = 'editortextarea1'></textarea></div> 
            <label for="editortextarea2">Полный текст</label>
            <div class = 'editortext'><textarea name="editor2" id = 'editortextarea2'></textarea></div>  
            <a href = 'addnews.php'  id = 'butonaddnews' class = 'previewa'><div id="butonadd">Добавить новость</div></a> 
        </div> 
        <script>
                ...
                $('#butonaddnews').bind("click", function(event)
                {
                    ...
                    else
                    {
                        $.ajax({
                            url: "addnews.php",
                            type: "POST",
                            data: ({Title: $('#titlebookedit').val(), PreviewText: editor1.getData(), Text: editor2.getData()}),
                            dataType: "html",
                            success: function(data)
                            {
                                if(data == "1") alert('Новость добавлена'); 
                                else alert('Ошибка'); 
